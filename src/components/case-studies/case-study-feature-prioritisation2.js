  ...
  return (
    <div className="case-study-overview white-bg padding-top-sm padding-bottom-sm">
      <div className="margin-bottom-sm narrow-container ">
        ...
        <p className="margin-bottom-sm line-height-md">Given the complexity of the project and based on the brief received from the SES, we have divided the features into 3 different tables based on our primary and secondary personas. These features will be used to produce our MVP.</p>
