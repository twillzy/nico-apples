  ...
  return (
    <div className="case-study-research white-bg padding-top-sm padding-bottom-sm">
      ...
      <div className="narrow-container">
        <h2 className="section-header">Interviews and Surveys</h2>
        ...
        <img className="width-100" src="https://static.wixstatic.com/media/bbeaac_6fc56f656305443b8961979f35f8c119~mv2.png/v1/fill/w_762,h_508,al_c,usm_0.66_1.00_0.01/bbeaac_6fc56f656305443b8961979f35f8c119~mv2.png" alt="" />
      </div>
    </div>
  );
};
